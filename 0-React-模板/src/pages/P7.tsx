...
import p1_1 from "@Assets/img/入党申请/1.jfif"
import p1_2 from "@Assets/img/入党申请/2.jpg"
...
export default function App() {
  return (
    <>
      <Section>
        <ListAdd className="NOLIST" backUrl={p1_2}>
          <li>
            <img
              ...
              alt=""
            />
            <TextBox fS={50} color="black">
              传承红色炬火 再续璀璨风华
            </TextBox>
          </li>
          <li>
            <hr style={{ width: "100%", background: "black" }} />
            <TextBox color="black" className="P3_5">
              汇报人 黎文宇 <br />
              汇报时间 2023.11.20
            </TextBox>
          </li>
      ...
      <Section>
        ...
        <Section back="">
          <Box>
            <ScrollDirectory width={"60%"} height={"40vh"}>
              <div style={{  width: "50px", height: "50px" }}>你好</div>
              <div style={{ width: "50px", height: "50px" }}>你好</div>
              <div style={{ width: "50px", height: "50px" }}>你好</div>
            </ScrollDirectory>
          </Box>
